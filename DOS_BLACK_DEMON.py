...
if int(prompt) == 0:
    ...
    host = input(RED + f"\u250c\u2500\u2500({os.getlogin()} @ BLACK_DEMON )-["+ YELLOW+"set-RHOST" + RED+"]\n\u2514> " + RESET)
    timeout = int(input(RED + f"\u250c\u2500\u2500({os.getlogin()}@ BLACK_DEMON )-["+ YELLOW+"set-Timeout Value" + RED+"]\n\u2514> " + RESET))
...
try:
    target = input(RED + f"\u250c\u2500\u2500({os.getlogin()} @ BLACK_DEMON )-["+ YELLOW+"set-RHOST" + RED+"]\n\u2514> " + RESET)
    attack_type = input(RED + f"\u250c\u2500\u2500({os.getlogin()} @ BLACK_DEMON )-["+ YELLOW+"set-ATTACK-TYPE" + RED+"]\n\u2514> " + RESET).upper()
    if attack_type :
        pass
    else:
        attack_type == 'UDP'
    port = int(input(RED + f"\u250c\u2500\u2500({os.getlogin()} @ BLACK_DEMON )-["+ YELLOW+"set-RPORT" + RED+"]\n\u2514> " + RESET))
    if port :
        pass
    else:
        port == 80
        
    threads = int(input(RED + f"\u250c\u2500\u2500({os.getlogin()} @ BLACK_DEMON )-["+ YELLOW+"set-THREADS" + RED+"]\n\u2514> " + RESET))
    if target :
        pass
    else:
        threads == int(input(RED + f"\u250c\u2500\u2500({os.getlogin()} @ BLACK_DEMON )-["+ YELLOW+"set-THREADS" + RED+"]\n\u2514> !" + RESET))
        if threads :
            ...
            exit()
    use_proxy = input(RED + f"\u250c\u2500\u2500({os.getlogin()} @ BLACK_DEMON )-["+ YELLOW+"use-PROXY" + RED+"]\n\u2514> " + RESET).lower() == "yes"
    proxy_ip = ""
    proxy_port = 0
    if use_proxy:
        proxy_ip = input(RED + f"\u250c\u2500\u2500({os.getlogin()} @ BLACK_DEMON )-["+ YELLOW+"set-PROXY-IP" + RED+"]\n\u2514> " + RESET)
        proxy_port = int(input(RED + f"\u250c\u2500\u2500({os.getlogin()} @ BLACK_DEMON )-["+ YELLOW+"set-PROXY-PORT" + RED+"]\n\u2514> " + RESET))
except ValueError:
...
USER_AGENTS = [
    ...
    "Mozilla/5.0 (iPad; CPU OS 14_0 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) BLACK_DEMONiOS/28.1 Mobile/15E148 Safari/605.1.15",
